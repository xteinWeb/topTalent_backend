  ...
  apps: [
    {
      ...
      env: {
        ...
        PORT: 3800,
        DB_USER: 'sa',
        DB_PASSWORD: 'sql2025SEadmin',
        DB_SERVER: '190.109.9.70',
        DB_NAME: 'TOP_TALENT',
        DB_PORT: 9788,
        DB_ENCRYPT: 'false',
        FRONTEND_URL: '',
        ...
        N8N_WEBHOOK_VALIDACION_URL: 'https://agentes.colchonessunmoon.com/webhook/74c18f61-aeb8-4aa2-9da8-78d15bbab166',
